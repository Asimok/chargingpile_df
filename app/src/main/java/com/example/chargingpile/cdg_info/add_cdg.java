...
public class add_cdg extends AppCompatActivity {
    private EditText bikeshedId, cpID, no, grp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_cdg);
            ...
            public void run() {
                try {
                    ...
                    Request request1 = new Request.Builder()
                            .url("http://123.56.106.24:8082/chargepile/insertBikeShedChargingpile")
                            .post(formBody)
                            .build();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d("data", status);
                    Toast.makeText(add_cdg.this, "status: " + status, Toast.LENGTH_SHORT).show();
