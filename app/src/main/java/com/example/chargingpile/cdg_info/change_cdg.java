...
public class change_cdg extends AppCompatActivity {
            ...
            public void run() {
                try {
                    ...
                    Request request1 = new Request.Builder()
                            .url("http://123.56.106.24:8082/chargepile/updateBikeShedChargingpile")
                            .post(formBody)
                            .build();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d("data", status);
                    Toast.makeText(change_cdg.this, "status: " + status, Toast.LENGTH_SHORT).show();
